...
public class JNI {
    ...
    public native void BackWeak(byte[] p1, byte[] p2, int p3, int p4, int[] p5, int[] p6, int p7, byte[]
            p8, int p9, int p10);
    ...
    public native void BackWeakLine(int[] p1, int[] p2, int p3, int p4, int[] p5, int[] p6, float p7, int
            p8, int p9);


    public native void BackWeakOne(int[] p1, int[] p2, int p3, int p4, int p5, int p6, byte[] p7, int p8,
                                   int p9);
